...
### 1. **ADMIN**
- **Full Access**: Complete system access including users, employees, documents, and system settings
...
### 2. **HR**
- **Access**: Manage all employees and generate documents
- **Dashboard**: Quick stats (Employees, Documents), "Generate Document" shortcut
- **Sidebar Access**: Dashboard, Assistant, Employees, Documents
- **Special Features**: Document generation, employee management
